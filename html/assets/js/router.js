...
////////////////////////////////////////////////////////////////////////////////////////////
	...
	router.prototype.query_model = function ( data, index, value )
	{
		for( var i in data )
		{
...
////////////////////////////////////////////////////////////////////////////////////////////
	...
	router.prototype.event_registry = {
			
/////////////////////////////////////////////////////////////////////////	Add Event To Event Bus
			add_event : function ( obj, type, fn, set, swap  )
			{
...
////////////////////////////////////////////////////////////////////////	Check Event Status
			...
			event_status : function ( id, type, fn )
			{
				var i = -1;
				var status = 'none';
...
//////////////////////////////////////////////////////////////////////////	Gets Event Index on Event Bus
			get_event_index : function ( id, type, fn )
			{
				var i = -1;
				while( ++i < event_bus.length )
				{
...
//////////////////////////////////////////////////////////////////		Handle Requests	->
			handle_requests : function ( what, obj, args )		//	Sort into variables
			{
...
//////////////////////////////////////////////////////////////		Then	->
			then: function ( what, obj, type, func, set, swap )
			{
				switch( what )
				{
...
///////////////////////////////////////////////////////////////		check for matches depending on supplied variables
			element_util : function ( what, obj, type, fn )
			{
				var id = obj.attr( 'id' );
