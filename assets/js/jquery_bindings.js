...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	;( function ( $ ){
		...
		$.fn.addEvent = function ()
		{
			...
			var _this = $( this );
			$.router.event_registry.handle_requests( 'add', _this, arguments );
			return _this;
		}
		...
		$.fn.removeEvent = function ()
		{
			...
			var _this = $( this );
			$.router.event_registry.handle_requests( 'remove', _this, arguments );
			return _this;
		}
		...
		$.fn.set = function ()
		{
			...
			var _this = $( this );
			$.router.event_registry.handle_requests( 'set', _this, arguments );
			return _this;
		}
		...
		$.fn.unset = function ()
		{
			...
			var _this = $( this );
			$.router.event_registry.handle_requests( 'unset', _this, arguments );
			return _this;
		}
		...
		{
			var _this = $( this );
			$.router.event_registry.add_swap( _this, arguments );
			return _this;
		}
